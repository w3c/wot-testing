...
| ECHONET Consortium | Air Conditioner  | x | x |  | HTTP           | VPN                                                                |  Operation can be confirmed via a live camera. It is a 15-year-old device so the response is slow.  | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/1homeAirconditioner.td.jsonld |
| ECHONET Consortium | General Light  | x | x |  | HTTP           | VPN                                                                | Operation can be confirmed via a live camera.  | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/2generalLight.td.jsonld |
| ECHONET Consortium | Air Cleaner  | x | x |  | HTTP           | VPN                                                                | Operation can be confirmed via a live camera. | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/7airCleaner.td.jsonld |
| ECHONET Consortium | Temperature sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/3temperatureSensor.td.jsonld |
| ECHONET Consortium | Human Detection sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/4humanDetectionSensor.td.jsonld |
| ECHONET Consortium | CO2 sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/5co2Sensor.td.jsonld |
| ECHONET Consortium | VOC sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/6vocSensor.td.jsonld |
| ECHONET Consortium | Smart Plug  | x | x |  | HTTP           | VPN                                                                | Operation can be confirmed via a live camera. | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/8smartPlug.td.jsonld |
| ECHONET Consortium | Human Detection sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/11humanDetectionSensor.td.jsonld |
| ECHONET Consortium | Temperature sensor  | x | x |  | HTTP           | VPN                                                                | Reading value can be confirmed via a live camera. | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/9temperatureSensor.td.jsonld |
| ECHONET Consortium | Humidity sensor  | x | x |  | HTTP           | VPN                                                                | Reading value can be confirmed via a live camera. | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/10humiditySensor.td |
| ECHONET Consortium | Door Lock  | x | x |  | HTTP           | VPN                                                                |  Operation can be confirmed via a live camera | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/12doorLock.td.jsonld |
| ECHONET Consortium | Open Close sensor  | x | x |  | HTTP           | VPN                                                                |                                                      | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/13openCloseSensor.td.jsonld |
| ECHONET Consortium | Fan  | x | x |  | HTTP           | VPN                                                                |        Operation can be confirmed via a live camera. | PHAM Van Cu, Tetsushi Matsuda | https://github.com/w3c/wot-testing/tree/main/events/2024.11.Munich/TDs/ECHONET/14fan.td.jsonld |
| ...          |     ...                                       |          |        |         |                    | ...                                                                |  ...                                                         |   tbc | |
