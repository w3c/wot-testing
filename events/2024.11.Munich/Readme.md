...
| Siemens      | Industrial Edge                               |  x       |        |         | OPC UA, HTTP       | LAN, connection to the Internet                                    | Table 1                                                      | Christian|
...
| Luminem      | esp32c3 [demo thermometer](https://github.com/wot-rust/wot-esp-demo)                      |  x       |        | x       | HTTP               | a [rust esp32c3 board](https://github.com/esp-rs/esp-rust-board) or compatible, Wifi                                         |                                                              | @lu-zero |
...
| Archeion     | Some RPis with Sensors                        |  x       |        |         | HTTP               | LAN                                                                | Table 8                                                      |     |
| Christian Paul | Small devices like e-paper display, sensors |  x       |        |         | HTTP               | LAN                                                                | Table 8                                                     |     |
