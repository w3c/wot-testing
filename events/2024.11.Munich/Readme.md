...
| Archeion     | Some RPis with Sensors                        |  x       |        |         | HTTP               | LAN                                                                | NEED Table                                                      |     |
| Christian Paul | Small devices like e-paper display, sensors |  x       |        |         | HTTP               | LAN                                                                | NEED Table                                                     |     |
| Christian Paul | Godot (game engine) Things                  |          |        | x       | WS, HTTP           | LAN                                                                | NEED Table                                                     |  @Jaller94   |
| ...          |     ...                                       |          |        |         |                    | ...                                                                |  ...                                                         |   tbc |
